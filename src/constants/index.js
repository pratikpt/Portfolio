...
export const workExperiences = [
  {
    ...
    title: [
      'Enhanced scalability and performance of Freshservice and Freshmarketer, focusing on UI optimization and IT Asset Management (ITAM) improvements.',
      'Implemented TypeScript support in Ember.js to improve codebase robustness and maintainability.',
      'Led frontend development teams to deliver projects on time, ensuring high-quality code reviews and optimized application performance.',
      'Directed seamless integration of software applications, ensuring UI and system compatibility.',
    ],
  ...
  },
  {
    ...
    title: [
      'Pioneered Micro Frontend Architecture using React Native for Web/Mobile, enabling over 50% reduction in development and testing time and accelerating product cycles.',
      'Developed Self-Serve Ads and Discounts modules for Swiggy, empowering businesses to autonomously manage promotions, driving revenue and customer engagement.',
      "Enhanced authentication security for Swiggy's vendor interfaces with a robust, user-friendly module to ensure a seamless experience.",
      'Contributed to the Design Language System (DLS) by designing the Discount coupon feature, ensuring UI consistency and adherence to brand standards.',
    ],
